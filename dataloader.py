    ...
    def __getitem__(self, item):
        ...
        if self.partition == 'train':
            ...
            if self.Augmentor is not None:
                ...
                origin = point_operation.rotate_point_cloud_and_gt(origin)
                origin = point_operation.jitter_perturbation_point_cloud(origin)
                ...
                return origin.astype(np.float32), pointcloud.astype(np.float32), label.astype(np.int32)
